var obj = {
  ...
  options: {
    ...
    render: function() {
      ...
      ctx.fillText(`Задание: ${tasks.get(task)}`, X(700), Y(20));
    },
    room: () => save()
  },
  assets: [
  ...
  rooms: [
    ...
    { id: "start:door:2:4", f: function() {
      ...
      if (task == "king") opt('Вы не видили короля?', () =>  { room('start:door:2:4:yes') });
